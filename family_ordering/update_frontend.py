...
<style>
    ...
    .hero-decoration.f1 { top: 10%; right: 10%; }
    .hero-decoration.f2 { bottom: 20%; left: 5%; }
    .hero-decoration.f3 { top: 50%; right: 20%; }
</style>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-center">
                <div style="height: 280px; font-size: 4rem; display: flex; align-items: center; justify-content: center; gap: 20px;">
    ...
    <div class="container">
        <div class="season-card">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-center" style="font-size: 3.5rem;">
                    🥬🍅🌶️
                </div>
            </div>
        </div>
...
<section id="dishes" class="py-12 wood-texture">
    <div class="container">
        ...
        <div class="category-tabs">
            ...
            {% if dishes_by_category.get(category) %}
            ...
            <div class="row row-cols-1 col-md-2 col-lg-3 col-xl-4 g-4">
                ...
                <div class="food-card card h-100">
                    <div class="food-image-container">
                        {% if dish.image %}
                        <img src="{{ dish.image }}" class="img-fluid" style="max-height: 160px; object-fit: cover;">
                        {% else %}
                        {% if dish.category == '素菜' %}🥬
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 col-md-2 col-lg-3 col-xl-4 g-4">
            ...
            <div class="food-card card h-100">
                <div class="food-image-container">
                    {% if fruit.image %}
                    <img src="{{ fruit.image }}" class="img-fluid" style="max-height: 160px; object-fit: cover;">
                    {% else %}
                    {% if fruit.name == '苹果' %}🍎
                    {% elif fruit.name == '香蕉' %}🍌
                    {% elif fruit.name == '橙子' %}🍊
...
<section id="login" class="py-12" style="background-color: #FFF8EF;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="card food-card">
                    <div style="background: linear-gradient(135deg, #F7A072 0%, #E88F5D 100%); padding: 1.5rem; text-align: center; color: white; border-radius: 16px 16px 0 0;">
                    ...
                    <div class="card-body p-5">
                        ...
                        <p class="text-center mt-4 text-[#88807A] text-sm">还没有账号？<a href="#register" class="text-[#F7A072] font-medium">立即注册</a></p>
                        {% else %}
...
<section id="register" class="py-12 wood-texture">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="card food-card">
                    ...
                    <div class="card-body p-5">
                        ...
                        <p class="text-center mt-4 text-[#88807A] text-sm">已有账号？<a href="#login" class="text-[#F7A072] font-medium">立即登录</a></p>
                        {% else %}
                        <div class="text-center py-6">
                            <div style="font-size: 3rem; margin-bottom: 0.5rem;">✅</div>
