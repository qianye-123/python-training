...
<style>
    ...
    .hero-food-icon:nth-child(1) { font-size: 4rem; top: 20%; left: 15%; animation: floatHero 4s ease-in-out infinite; }
    .hero-food-icon:nth-child(2) { font-size: 3rem; top: 60%; left: 25%; animation: floatHero 4s ease-in-out infinite 0.5s; }
    .hero-food-icon:nth-child(3) { font-size: 3.5rem; top: 35%; left: 50%; animation: floatHero 4s ease-in-out infinite 1s; }
    .hero-food-icon:nth-child(4) { font-size: 2.8rem; top: 70%; left: 65%; animation: floatHero 4s ease-in-out infinite 1.5s; }
    .hero-food-icon:nth-child(5) { font-size: 3.2rem; top: 25%; left: 75%; animation: floatHero 4s ease-in-out infinite 2s; }
    
    @keyframes floatHero {
        0%, 100% { transform: translateY(0) rotate(0deg); z-index: 1; }
        25% { transform: translateY(-15px) rotate(3deg); z-index: 3; }
        50% { transform: translateY(-25px) rotate(-2deg); z-index: 5; }
        75% { transform: translateY(-10px) rotate(2deg); z-index: 3; }
    }
    ...
    @media (max-width: 1199px) {
        .flex-grid-item { flex: 0 0 calc(100% / 4); }
    }
    
    @media (max-width: 991px) {
        .flex-grid-item { flex: 0 0 calc(100% / 3); }
    }
    
    @media (max-width: 767px) {
        .flex-grid-item { flex: 0 0 calc(100% / 2); }
    }
    
    @media (max-width: 575px) {
        .flex-grid-item { flex: 0 0 100%; }
    }
</style>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="flex-grid">
                    ...
                    <div class="flex-grid-item" style="flex: 0 0 calc(100% / 3);">
...
with open(r'D:\Python\python-training-main\family_ordering\templates\index.html', 'w', encoding='utf-8') as f:
    f.write(content)
print('Index.html updated with AJAX login/register')