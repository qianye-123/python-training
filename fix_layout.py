    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-center">
                <div id="hero-icons" style="height: 250px; display: flex; align-items: center; justify-content: center; gap: 15px;">
                    <span class="floating-icon" data-target="🍳">🍳</span>
                    <span class="floating-icon" data-target="🥗">🥗</span>
                    <span class="floating-icon" data-target="🍎">🍎</span>
                    <span class="floating-icon" data-target="🥕">🥕</span>
                    <span class="floating-icon" data-target="🥦">🥦</span>
    ...
    <div class="container">
        <div class="season-card">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-center" id="seasonal-icons">
                    <div class="floating-icon" style="font-size: 2.5rem;">🥬</div>
                    <div class="floating-icon" style="font-size: 2.5rem;">🍅</div>
                    <div class="floating-icon" style="font-size: 2.5rem;">🌶️</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div id="category-{{ category }}" class="category-content">
            <div class="row" style="display: flex; flex-wrap: wrap; margin: 0 -12px;">
                {% for item in dishes %}
                {% with dish=item.dish %}
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" style="padding: 0 12px; margin-bottom: 24px;">
                    <div class="food-card card h-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            {% endif %}
                            {% if user.is_authenticated %}
                            <form action="{% url 'add_to_cart' %}" method="post" style="display: flex; gap: 4px;">
                                {% csrf_token %}
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row" style="display: flex; flex-wrap: wrap; margin: 0 -12px;">
                    {% for stock in stocks %}
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" style="padding: 0 12px; margin-bottom: 12px;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row" style="display: flex; flex-wrap: wrap; margin: 0 -12px;">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3" style="padding: 0 12px; margin-bottom: 24px;">
...
<script>
    ...
    const heroIcons = document.querySelectorAll('#hero-icons .floating-icon');
    const seasonalIcons = document.querySelectorAll('#seasonal-icons .floating-icon');
    ...
    window.addEventListener('scroll', () => {
        ...
        const seasonalRect = seasonalSection.getBoundingClientRect();
        
        const heroBottom = heroRect.bottom;
        const seasonalTop = seasonalRect.top;
        
        if (heroBottom > 0 && heroBottom < window.innerHeight && seasonalTop < window.innerHeight) {
            const progress = 1 - (heroBottom / window.innerHeight);
            
            heroIcons.forEach((icon, index) => {
                if (index < seasonalIcons.length) {
                    const seasonalIcon = seasonalIcons[index];
                    const heroRect = icon.getBoundingClientRect();
                    const seasonalRect = seasonalIcon.getBoundingClientRect();
                    
                    const offsetX = seasonalRect.left - heroRect.left;
                    const offsetY = seasonalRect.top - heroRect.top;
                    
                    icon.style.transform = `translate(${offsetX * progress}px, ${offsetY * progress}px) scale(${1 - progress * 0.3})`;
                    icon.style.opacity = 1 - progress;
                }
            });
            
            seasonalIcons.forEach((icon, index) => {
                if (index < heroIcons.length) {
                    icon.style.opacity = progress;
                    icon.style.transform = `scale(${0.7 + progress * 0.3})`;
                }
            });
        } else {
